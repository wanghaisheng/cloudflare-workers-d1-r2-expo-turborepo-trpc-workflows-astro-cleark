...
- Are non-trivial tasks being decomposed into WBS-style milestone slices instead of one branch-sized lump?
...
- milestone naming and sizing feel predictable instead of improvised
...
- planning truth that lives only in chat and not in repository files
